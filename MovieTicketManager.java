...
implements MovieTicketManagerInterface {
	...
	public double addTicket(String movieN, String rating, int d, int t, String f,
		...
		switch(type) {
		case "Adult":
			ticket = new Adult(movieN, rating, t, d, f);
			ticketList.add(ticket);
			price = ticket.calculateTicketPrice();
			break;
		case "Child":
			ticket = new Child(movieN, rating, t, d, f);
			ticketList.add(ticket);
			price = ticket.calculateTicketPrice();
			break;
		case "Employee":
			int numVisits=numVisits(id);
			ticket=new Employee(movieN, rating, t, d, f, id, numVisits);
			ticketList.add(ticket);
			price = ticket.calculateTicketPrice();
			break;
		case "MoviePass":
			...
			ticket=new MoviePass(movieN, rating, t, d, f, id, numVisits1, 
	 ...
	 * 
	 */
	public String monthlySalesReport() {int numAdultTicket = 0;
